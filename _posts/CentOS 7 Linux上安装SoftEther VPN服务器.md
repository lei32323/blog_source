...
![img](../images/20180520135442.png)

这里选择第三个（管理工具），下一步安装结束，打开软件：

![img](../images/20180520141603.png)

点击新设置

主机名填服务器的地址或域名，端口选择之前设置的5555，密码设置之前设置的管理密码：

![img](../images/20180520141845.png)

![img](../images/20180520142012.png)

选择远程访问VPN Server

![img](../images/20180520142040.png)



启动L2TP，设置IPsec 预共享密钥

![img](../images/20180520142302.png)



这个没什么用，禁用确当即可。

![img](../images/20180520142443.png)



![img](../images/20180520142804.png)



这里新建用户，用于连接VPN服务器。如图配置好，点确定。

![img](../images/20180520143006.png)



这里点击管理虚拟HUB。

![img](../images/20180520143050.png)



![img](../images/20180520143119.png)



![img](../images/20180520143207.png)
...
![image-20200406153244932](../images/image-20200406153244932.png)



下载完成后打开

![技术分享图片](../images/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=.png)



填入服务端 的配置

![技术分享图片](../images/1231234.png)



双击 连接

![技术分享图片](../images/313114.png)
...
![image-20200406153748771](../images/image-20200406153748771.png)
...
![image-20200406153911910](../images/image-20200406153911910.png)